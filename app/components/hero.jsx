  ...
  return (
    <div className="flex flex-row items-center mx-auto flex-1  ">
      <div className='flex flex-col mx-auto w-1/2 pl-8 '>
        ...
        <Link href="/signin" className=" text-xl flex flex-row rounded gap-2 shadow-[0_3px_0_rgb(67,56,202)] w-min text-nowrap px-9 py-3 my-4 text-white bg-gradient-to-r from-blue-600 to-blue-800  hover:bg-blue-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-blue-800">
