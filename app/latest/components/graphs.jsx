...
const Graphs = ({ transactions }) => {
  ...
  return (
    <div className="min-h-72 flex flex-col">
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-600 leading-tight mb-3 sm:mb-6 mx-auto"></h1>
