            ...
            <div className="container mx-auto">
                ...
                <Link href="/latest" className="my-auto text-white text-lg font-bold flex flex-row"> 
                    ...
                    <div className="flex space-x-4">
                        {userId ? (
                            <>
                                <Link href={`/latest/predizioni/${userId}`} className="my-auto flex flex-row gap-2 shadow-[0_3px_0_rgb(67,56,202)] w-min text-nowrap px-6 py-2 text-white bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl hover:bg-blue-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-blue-800"> 
                                    Predizioni
                                </Link>
